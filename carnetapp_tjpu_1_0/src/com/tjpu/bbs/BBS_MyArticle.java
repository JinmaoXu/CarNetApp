...
import com.tjpu.bbs.BBS_Mycollect.info_adapter;
 ...
 *
 */
public class BBS_MyArticle extends Activity implements IReflashListener{
	...
	public void inint(){
		...
		tv_title=(TextView)findViewById(R.id.bbs_mycollect_tv_title);
		tv_title.setText("我发布的帖子");
	...
	public void get_info() {
		...
		String url = "http://"
				+ IP
				+ ":8080/CarNetApp/questionServlet?type=get_user_article&user_id="
				+ str_user_id;
	...
	public void delete_collect(String str_contentmenu_id){
		...
		HttpUtils utils=new HttpUtils(5000);
		String url = "http://"+IP+":8080/CarNetApp/questionServlet?type=delete_user_article&user_id="
